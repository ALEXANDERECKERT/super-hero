...
function LoadGameMenu () {
    ...
    textSprite.setPosition(80, 73)
}
function setSuperPowerL () {
    if (selectedPowerNumber == 2) {
        selectedPowerNumber = 0
    } else {
    ...
    textSprite.setText(PowerNames[selectedPowerNumber])
    if (selectedPowerNumber == 2) {
        scaling.scaleToPercent(SelectedPowerSprite, 300, ScaleDirection.Uniformly, ScaleAnchor.BottomRight)
        SelectedPowerSprite.setPosition(95, 115)
        textSprite.setPosition(80, 73)
    } else if (selectedPowerNumber == 1) {
        scaling.scaleToPercent(SelectedPowerSprite, 100, ScaleDirection.Uniformly, ScaleAnchor.BottomRight)
        SelectedPowerSprite.setPosition(80, 105)
        textSprite.setPosition(80, 73)
    } else {
        scaling.scaleToPercent(SelectedPowerSprite, 100, ScaleDirection.Uniformly, ScaleAnchor.BottomRight)
        SelectedPowerSprite.setPosition(78, 100)
        textSprite.setPosition(80, 73)
    }
}
function LoadGame () {
